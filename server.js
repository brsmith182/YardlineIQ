...
const UPCOMING_GAMES = [
  ...
  },
  {
    ...
    spread: { open: -1.5, current: 2.5, home: -101, away: -117 },
    total: { current: 43.5, over: -110, under: -109 },
    moneyline: { home: 125, away: -152 },
    split: { moneyHome: 19, ticketsHome: 29 },
  },
  {
    ...
    spread: { open: -7.5, current: -8.5, home: -106, away: -111 },
    total: { current: 46, over: -107, under: -111 },
    moneyline: { home: -412, away: 329 },
    split: { moneyHome: 84, ticketsHome: 80 },
  },
  {
    ...
    home: "Chicago Bears",
    spread: { open: -3.5, current: -4.5, home: -110, away: -109 },
    total: { current: 47.5, over: -119, under: -107 },
    moneyline: { home: -220, away: 180 },
    split: { moneyHome: 52, ticketsHome: 60 },
  },
  {
    ...
    home: "Houston Texans",
    spread: { open: -2.5, current: -2.5, home: -113, away: -105 },
    total: { current: 45.5, over: -110, under: -109 },
    moneyline: { home: -145, away: 120 },
    split: { moneyHome: 35, ticketsHome: 45 },
  },
  {
    ...
    spread: { open: -4.5, current: -5.5, home: -109, away: -110 },
    total: { current: 41.5, over: -109, under: -110 },
    moneyline: { home: -237, away: 195 },
    split: { moneyHome: 44, ticketsHome: 40 },
  },
  {
    ...
    home: "New York Jets",
    spread: { open: 6.5, current: 3.5, home: -114, away: -104 },
    total: { current: 44.5, over: -110, under: -110 },
    moneyline: { home: 150, away: -182 },
    split: { moneyHome: 45, ticketsHome: 22 },
  },
  {
    ...
    spread: { open: -5.5, current: -8.5, home: -109, away: -111 },
    total: { current: 41.5, over: -108, under: -110 },
    moneyline: { home: -450, away: 350 },
    split: { moneyHome: 94, ticketsHome: 86 },
  },
  {
    ...
    spread: { open: 4.5, current: 7, home: -107, away: -112 },
    total: { current: 39.5, over: -110, under: -110 },
    moneyline: { home: 272, away: -350 },
    split: { moneyHome: 3, ticketsHome: 6 },
  },
  {
    ...
    home: "Denver Broncos",
    spread: { open: -2.5, current: -2.5, home: -119, away: -102 },
    total: { current: 45.5, over: -108, under: -110 },
    moneyline: { home: -158, away: 130 },
    split: { moneyHome: 11, ticketsHome: 30 },
  },
  {
    ...
    spread: { open: -8.5, current: -6.5, home: -115, away: -105 },
    total: { current: 43.5, over: -110, under: -110 },
    moneyline: { home: -300, away: 240 },
    split: { moneyHome: 47, ticketsHome: 42 },
  },
  {
    ...
    spread: { open: 10, current: 4, home: -108, away: -110 },
    total: { current: 41, over: -105, under: -112 },
    moneyline: { home: 171, away: -210 },
  ...
  },
  {
    ...
    home: "Dallas Cowboys",
    spread: { open: -4.5, current: -4, home: -108, away: -110 },
    total: { current: 50.5, over: -113, under: -105 },
    moneyline: { home: -210, away: 170 },
    split: { moneyHome: 40, ticketsHome: 38 },
  },
  {
    ...
    moneyline: { home: -950, away: 645 },
    split: { moneyHome: 82, ticketsHome: 82 },
  },
  {
  ...
  },
  {
    ...
    spread: { open: -8.5, current: -6.5, home: -116, away: -104 },
    total: { current: 47.5, over: -109, under: -110 },
    moneyline: { home: -300, away: 245 },
    split: { moneyHome: 40, ticketsHome: 44 },
  },
];
