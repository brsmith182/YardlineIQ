...
const UPCOMING_GAMES = [
  ...
  },
  {
    ...
    moneyline: { home: -200, away: 166 },
    split: { moneyHome: 34, ticketsHome: 59 },
  },
  {
    ...
    spread: { open: 2.5, current: 3, home: -128, away: -114 },
    total: { current: 46.5, over: -120, under: -110 },
    moneyline: { home: 145, away: -175 },
    split: { moneyHome: 36, ticketsHome: 34 },
  },
  {
    ...
    spread: { open: -3.5, current: -3.5, home: -111, away: -120 },
    total: { current: 50.5, over: -108, under: -108 },
    moneyline: { home: -210, away: 170 },
    split: { moneyHome: 30, ticketsHome: 44 },
  },
  {
    ...
    home: "Detroit Lions",
    spread: { open: -7.5, current: -7, home: -122, away: -111 },
    total: { current: 49.5, over: -112, under: -120 },
    moneyline: { home: -325, away: 260 },
    split: { moneyHome: 67, ticketsHome: 57 },
  },
  {
    ...
    away: "Buffalo Bills",
    home: "Houston Texans",
    spread: { open: 1.5, current: 1.5, home: -112, away: -118 },
    total: { current: 44.5, over: -109, under: -108 },
    moneyline: { home: -100, away: -120 },
    split: { moneyHome: 49, ticketsHome: 47 },
  },
  {
    ...
    spread: { open: 4.5, current: 3.5, home: -115, away: -118 },
    total: { current: 47.5, over: -111, under: -110 },
    moneyline: { home: 145, away: -175 },
    split: { moneyHome: 49, ticketsHome: 35 },
  },
  {
    ...
    spread: { open: -7.5, current: -8.5, home: -110, away: -117 },
    total: { current: 39.5, over: -127, under: -115 },
    moneyline: { home: -450, away: 333 },
    split: { moneyHome: 78, ticketsHome: 62 },
  },
  {
    ...
    spread: { open: -2.5, current: -6.5, home: -118, away: -105 },
    total: { current: 40.5, over: -108, under: -123 },
    moneyline: { home: -290, away: 232 },
    split: { moneyHome: 85, ticketsHome: 59 },
  },
  {
    ...
    spread: { open: -1.5, current: -1.5, home: -109, away: -111 },
    total: { current: 38.5, over: -110, under: -108 },
    moneyline: { home: -120, away: 101 },
    split: { moneyHome: 47, ticketsHome: 57 },
  },
  {
    ...
    spread: { open: -8.5, current: -9.5, home: -111, away: -105 },
    total: { current: 47.5, over: -102, under: -111 },
    moneyline: { home: -510, away: 380 },
    split: { moneyHome: 76, ticketsHome: 64 },
  },
  {
    ...
    spread: { open: -3, current: -3, home: -110, away: -105 },
    total: { current: 39.5, over: -118, under: -114 },
    moneyline: { home: -172, away: 140 },
    split: { moneyHome: 59, ticketsHome: 50 },
  },
  {
    ...
    spread: { open: 2.5, current: -2, home: -110, away: -108 },
    total: { current: 45.5, over: -114, under: -108 },
    moneyline: { home: -134, away: 110 },
    split: { moneyHome: 57, ticketsHome: 50 },
  },
  {
    ...
    spread: { open: -4.5, current: -5.5, home: -110, away: -108 },
    total: { current: 44, over: -113, under: -114 },
    moneyline: { home: -250, away: 201 },
    split: { moneyHome: 70, ticketsHome: 61 },
  },
  {
    ...
    spread: { open: 2.5, current: 3, home: -110, away: -105 },
    total: { current: 47.5, over: -110, under: -115 },
    moneyline: { home: 137, away: -165 },
    split: { moneyHome: 25, ticketsHome: 50 },
  },
  {
    ...
    spread: { open: -2.5, current: -2.5, home: -110, away: -106 },
    total: { current: 43.5, over: -110, under: -108 },
    moneyline: { home: -139, away: 114 },
    split: { moneyHome: 17, ticketsHome: 28 },
  },
];
