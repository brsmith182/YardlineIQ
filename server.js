...
const UPCOMING_GAMES = [
  ...
  },
  {
    ...
    spread: { open: -1.5, current: 2.5, home: -102, away: -118 },
    total: { current: 43.5, over: -115, under: -105 },
    moneyline: { home: 130, away: -132 },
    split: { moneyHome: 24, ticketsHome: 27 },
  },
  {
    id: '2026-w2-no-at-bal',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "New Orleans Saints",
    home: "Baltimore Ravens",
    spread: { open: -7.5, current: -8.5, home: -105, away: -115 },
    total: { current: 46.5, over: -118, under: -102 },
    moneyline: { home: -380, away: 325 },
    split: { moneyHome: 79, ticketsHome: 74 },
  },
  {
    id: '2026-w2-min-at-chi',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Minnesota Vikings",
    home: "Chicago Bears",
    spread: { open: -3.5, current: -4.5, home: -108, away: -112 },
    total: { current: 48.5, over: -110, under: -110 },
    moneyline: { home: -205, away: 188 },
    split: { moneyHome: 63, ticketsHome: 52 },
  },
  {
    id: '2026-w2-cin-at-hou',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Cincinnati Bengals",
    home: "Houston Texans",
    spread: { open: -2.5, current: -3, home: -102, away: -118 },
    total: { current: 46.5, over: -110, under: -110 },
    moneyline: { home: -146, away: 128 },
    split: { moneyHome: 45, ticketsHome: 43 },
  },
  {
    id: '2026-w2-pit-at-ne',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Pittsburgh Steelers",
    home: "New England Patriots",
    spread: { open: -4.5, current: -5.5, home: -105, away: -115 },
    total: { current: 41.5, over: -112, under: -108 },
    moneyline: { home: -218, away: 210 },
    split: { moneyHome: 49, ticketsHome: 39 },
  },
  {
    id: '2026-w2-gb-at-nyj',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Green Bay Packers",
    home: "New York Jets",
    spread: { open: 6.5, current: 3.5, home: -108, away: -112 },
    total: { current: 44.5, over: -110, under: -110 },
    moneyline: { home: 162, away: -182 },
    split: { moneyHome: 48, ticketsHome: 37 },
  },
  {
    id: '2026-w2-cle-at-tb',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Cleveland Browns",
    home: "Tampa Bay Buccaneers",
    spread: { open: -5.5, current: -8.5, home: -108, away: -112 },
    total: { current: 41.5, over: -110, under: -110 },
    moneyline: { home: -420, away: 360 },
    split: { moneyHome: 92, ticketsHome: 79 },
  },
  {
    id: '2026-w2-phi-at-ten',
    season: 2026, week: 2,
    kickoff: '2026-09-20T13:00:00-04:00',
    away: "Philadelphia Eagles",
    home: "Tennessee Titans",
    spread: { open: 4.5, current: 7, home: -108, away: -112 },
    total: { current: 39.5, over: -110, under: -110 },
    moneyline: { home: 280, away: -325 },
    split: { moneyHome: 6, ticketsHome: 13 },
  },
  {
    id: '2026-w2-jac-at-den',
    season: 2026, week: 2,
    kickoff: '2026-09-20T16:05:00-04:00',
    away: "Jacksonville Jaguars",
    home: "Denver Broncos",
    spread: { open: -2.5, current: -2.5, home: -118, away: -102 },
    total: { current: 45.5, over: -108, under: -112 },
    moneyline: { home: -148, away: 127 },
    split: { moneyHome: 26, ticketsHome: 39 },
  },
  {
    id: '2026-w2-lv-at-lac',
    season: 2026, week: 2,
    kickoff: '2026-09-20T16:05:00-04:00',
    away: "Las Vegas Raiders",
    home: "Los Angeles Chargers",
    spread: { open: -8.5, current: -6.5, home: -118, away: -102 },
    total: { current: 43.5, over: -110, under: -110 },
    moneyline: { home: -300, away: 250 },
    split: { moneyHome: 47, ticketsHome: 37 },
  },
  {
    ...
    spread: { open: 10, current: 3.5, home: 100, away: -120 },
    total: { current: 40.5, over: -118, under: -102 },
    moneyline: { home: 180, away: -196 },
    split: { moneyHome: 40, ticketsHome: 41 },
  },
  {
    id: '2026-w2-wsh-at-dal',
    season: 2026, week: 2,
    kickoff: '2026-09-20T16:25:00-04:00',
    away: "Washington Commanders",
    home: "Dallas Cowboys",
    spread: { open: -4.5, current: -4.5, home: -105, away: -115 },
    total: { current: 50.5, over: -108, under: -112 },
    moneyline: { home: -205, away: 180 },
    split: { moneyHome: 32, ticketsHome: 31 },
  },
  {
    id: '2026-w2-mia-at-sf',
    season: 2026, week: 2,
    kickoff: '2026-09-20T16:25:00-04:00',
    away: "Miami Dolphins",
    home: "San Francisco 49ers",
    spread: { open: -10.5, current: -13.5, home: -105, away: -115 },
    total: { current: 44.5, over: -115, under: -105 },
    moneyline: { home: -952, away: 660 },
    split: { moneyHome: 72, ticketsHome: 77 },
  },
  {
    ...
    spread: { open: -5.5, current: -6.5, home: -120, away: 100 },
    total: { current: 46.5, over: -110, under: -110 },
    moneyline: { home: -285, away: 265 },
    split: { moneyHome: 79, ticketsHome: 64 },
  },
  {
    id: '2026-w2-nyg-at-lar',
    season: 2026, week: 2,
    kickoff: '2026-09-21T20:15:00-04:00',
    away: "New York Giants",
    home: "Los Angeles Rams",
    spread: { open: -8.5, current: -7, home: -115, away: -105 },
    total: { current: 47.5, over: -115, under: -105 },
    moneyline: { home: -345, away: 290 },
    split: { moneyHome: 36, ticketsHome: 31 },
  },
];
