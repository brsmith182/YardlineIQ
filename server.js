...
const GAMES_AS_OF = '2026-09-23';

const UPCOMING_GAMES = [
  {
    id: '2026-w3-atl-at-gb',
    season: 2026, week: 3,
    kickoff: '2026-09-24T20:15:00-04:00',
    away: "Atlanta Falcons",
    home: "Green Bay Packers",
    spread: { open: -7.5, current: -5, home: -110, away: -109 },
    total: { current: 43.5, over: -105, under: -111 },
    moneyline: { home: -261, away: 207 },
    split: { moneyHome: 45, ticketsHome: 51 },
  },
  {
    id: '2026-w3-lac-at-buf',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Los Angeles Chargers",
    home: "Buffalo Bills",
    spread: { open: -3, current: -7, home: -115, away: -105 },
    total: { current: 50.5, over: -105, under: -115 },
    moneyline: { home: -358, away: 280 },
    split: { moneyHome: 61, ticketsHome: 74 },
  },
  {
    id: '2026-w3-car-at-cle',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Carolina Panthers",
    home: "Cleveland Browns",
    spread: { open: 1.5, current: 2.5, home: -101, away: -120 },
    total: { current: 42, over: -110, under: -111 },
    moneyline: { home: 125, away: -150 },
    split: { moneyHome: 21, ticketsHome: 21 },
  },
  {
    id: '2026-w3-nyj-at-det',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "New York Jets",
    home: "Detroit Lions",
    spread: { open: -9.5, current: -6.5, home: -115, away: -105 },
    total: { current: 47.5, over: -115, under: -105 },
    moneyline: { home: -320, away: 252 },
    split: { moneyHome: 57, ticketsHome: 70 },
  },
  {
    id: '2026-w3-hou-at-ind',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Houston Texans",
    home: "Indianapolis Colts",
    spread: { open: 1.5, current: 2.5, home: -102, away: -119 },
    total: { current: 42.5, over: -112, under: -109 },
    moneyline: { home: 126, away: -153 },
    split: { moneyHome: 56, ticketsHome: 58 },
  },
  {
    id: '2026-w3-ne-at-jac',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "New England Patriots",
    home: "Jacksonville Jaguars",
    spread: { open: -1.5, current: -3, home: -111, away: -109 },
    total: { current: 45.5, over: -105, under: -113 },
    moneyline: { home: -160, away: 133 },
    split: { moneyHome: 51, ticketsHome: 35 },
  },
  {
    id: '2026-w3-kc-at-mia',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Kansas City Chiefs",
    home: "Miami Dolphins",
    spread: { open: 7.5, current: 11.5, home: -110, away: -110 },
    total: { current: 46.5, over: -105, under: -112 },
    moneyline: { home: 545, away: -760 },
    split: { moneyHome: 7, ticketsHome: 15 },
  },
  {
    id: '2026-w3-ten-at-nyg',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Tennessee Titans",
    home: "New York Giants",
    spread: { open: -3, current: -3, home: -112, away: -110 },
    total: { current: 39.5, over: -110, under: -110 },
    moneyline: { home: -151, away: 125 },
    split: { moneyHome: 53, ticketsHome: 48 },
  },
  {
    id: '2026-w3-cin-at-pit',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Cincinnati Bengals",
    home: "Pittsburgh Steelers",
    spread: { open: 1.5, current: 3.5, home: -109, away: -111 },
    total: { current: 42.5, over: -110, under: -109 },
    moneyline: { home: 155, away: -187 },
    split: { moneyHome: 15, ticketsHome: 30 },
  },
  {
    id: '2026-w3-sea-at-wsh',
    season: 2026, week: 3,
    kickoff: '2026-09-27T13:00:00-04:00',
    away: "Seattle Seahawks",
    home: "Washington Commanders",
    spread: { open: 3.5, current: 7, home: -106, away: -113 },
    total: { current: 40.5, over: -106, under: -113 },
    moneyline: { home: 255, away: -319 },
    split: { moneyHome: 8, ticketsHome: 15 },
  },
  {
    id: '2026-w3-ari-at-sf',
    season: 2026, week: 3,
    kickoff: '2026-09-27T16:05:00-04:00',
    away: "Arizona Cardinals",
    home: "San Francisco 49ers",
    spread: { open: -11.5, current: -8.5, home: -109, away: -110 },
    total: { current: 47.5, over: -115, under: -105 },
    moneyline: { home: -452, away: 345 },
    split: { moneyHome: 82, ticketsHome: 74 },
  },
  {
    id: '2026-w3-min-at-tb',
    season: 2026, week: 3,
    kickoff: '2026-09-27T16:05:00-04:00',
    away: "Minnesota Vikings",
    home: "Tampa Bay Buccaneers",
    spread: { open: -1.5, current: 1.5, home: -111, away: -109 },
    total: { current: 42.5, over: -112, under: -109 },
    moneyline: { home: -100, away: -121 },
    split: { moneyHome: 47, ticketsHome: 34 },
  },
  {
    id: '2026-w3-bal-at-dal',
    season: 2026, week: 3,
    ...
    total: { current: 52.5, over: -109, under: -110 },
    moneyline: { home: 145, away: -175 },
    split: { moneyHome: 22, ticketsHome: 54 },
  },
  {
    id: '2026-w3-lv-at-no',
    season: 2026, week: 3,
    ...
    spread: { open: -3.5, current: -3, home: -118, away: -103 },
    total: { current: 43.5, over: -120, under: -103 },
    moneyline: { home: -177, away: 145 },
    split: { moneyHome: 39, ticketsHome: 43 },
  },
  {
    id: '2026-w3-lar-at-den',
    season: 2026, week: 3,
    kickoff: '2026-09-27T20:20:00-04:00',
    away: "Los Angeles Rams",
    home: "Denver Broncos",
    spread: { open: 3, current: 2.5, home: -105, away: -115 },
    total: { current: 45.5, over: -107, under: -110 },
    moneyline: { home: 120, away: -143 },
    split: { moneyHome: 27, ticketsHome: 39 },
  },
  {
    id: '2026-w3-phi-at-chi',
    season: 2026, week: 3,
    kickoff: '2026-09-28T20:15:00-04:00',
    away: "Philadelphia Eagles",
    home: "Chicago Bears",
    spread: { open: -1.5, current: 4.5, home: -110, away: -110 },
    total: { current: 41.5, over: -113, under: -109 },
    moneyline: { home: 183, away: -225 },
    split: { moneyHome: 20, ticketsHome: 37 },
  },
];
