...
const UPCOMING_GAMES = [
  {
    ...
    spread: { open: -7.5, current: -4.5, home: -115, away: -105 },
    total: { current: 43.5, over: -101, under: -117 },
    moneyline: { home: -250, away: 205 },
    split: { moneyHome: 37, ticketsHome: 53 },
  },
  {
    ...
    home: "Buffalo Bills",
    spread: { open: -3, current: -7.5, home: -107, away: -114 },
    total: { current: 50.5, over: -105, under: -115 },
    moneyline: { home: -350, away: 275 },
    split: { moneyHome: 72, ticketsHome: 78 },
  },
  {
    ...
    spread: { open: 1.5, current: 2.5, home: -105, away: -117 },
    total: { current: 42.5, over: -108, under: -111 },
    moneyline: { home: 122, away: -147 },
    split: { moneyHome: 27, ticketsHome: 20 },
  },
  {
    ...
    total: { current: 47.5, over: -111, under: -109 },
    moneyline: { home: -317, away: 250 },
    split: { moneyHome: 69, ticketsHome: 76 },
  },
  {
    ...
    spread: { open: 1.5, current: 1.5, home: -106, away: -112 },
    total: { current: 42.5, over: -112, under: -108 },
    moneyline: { home: 105, away: -129 },
    split: { moneyHome: 59, ticketsHome: 58 },
  },
  {
    ...
    spread: { open: -1.5, current: -3, home: -105, away: -115 },
    total: { current: 45.5, over: -110, under: -110 },
    moneyline: { home: -155, away: 130 },
    split: { moneyHome: 51, ticketsHome: 36 },
  },
  {
    ...
    home: "Miami Dolphins",
    spread: { open: 7.5, current: 10.5, home: -106, away: -113 },
    total: { current: 46, over: -112, under: -107 },
    moneyline: { home: 487, away: -674 },
    split: { moneyHome: 6, ticketsHome: 12 },
  },
  {
    ...
    spread: { open: -3, current: -2.5, home: -117, away: -105 },
    total: { current: 38.5, over: -109, under: -111 },
    moneyline: { home: -143, away: 120 },
    split: { moneyHome: 35, ticketsHome: 31 },
  },
  {
    ...
    spread: { open: 1.5, current: 3.5, home: -110, away: -109 },
    total: { current: 42.5, over: -111, under: -108 },
    moneyline: { home: 156, away: -190 },
    split: { moneyHome: 17, ticketsHome: 26 },
  },
  {
    ...
    spread: { open: 3.5, current: 7.5, home: -112, away: -108 },
    total: { current: 40.5, over: -106, under: -113 },
    moneyline: { home: 285, away: -365 },
    split: { moneyHome: 8, ticketsHome: 11 },
  },
  {
    ...
    split: { moneyHome: 86, ticketsHome: 82 },
  },
  {
    ...
    spread: { open: -1.5, current: 1.5, home: -111, away: -108 },
    total: { current: 42.5, over: -110, under: -110 },
    moneyline: { home: 102, away: -124 },
    split: { moneyHome: 40, ticketsHome: 40 },
  },
  {
    ...
    moneyline: { home: 150, away: -184 },
    split: { moneyHome: 28, ticketsHome: 53 },
  },
  {
    id: '2026-w3-lv-at-no',
    season: 2026, week: 3,
    ...
    spread: { open: -3.5, current: -3.5, home: -104, away: -113 },
    total: { current: 43.5, over: -111, under: -109 },
    moneyline: { home: -177, away: 145 },
    split: { moneyHome: 42, ticketsHome: 44 },
  },
  {
    ...
    home: "Denver Broncos",
    spread: { open: 3, current: 2.5, home: -110, away: -110 },
    total: { current: 45, over: -112, under: -110 },
    moneyline: { home: 115, away: -140 },
    split: { moneyHome: 29, ticketsHome: 37 },
  },
  {
    ...
    home: "Chicago Bears",
    spread: { open: -1.5, current: 4.5, home: -105, away: -115 },
    total: { current: 41.5, over: -105, under: -113 },
    moneyline: { home: 185, away: -234 },
    split: { moneyHome: 20, ticketsHome: 28 },
  },
];
