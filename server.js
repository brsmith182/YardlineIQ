...
const UPCOMING_GAMES = [
  {
    ...
    spread: { open: -4.5, current: -3.5, home: -102, away: -118 },
    total: { current: 44.5, over: -105, under: -133 },
    moneyline: { home: -175, away: 165 },
  ...
  },
  {
    ...
    neutralSite: true,
    spread: { open: -2.5, current: -3.5, home: -108, away: -112 },
    total: { current: 48.5, over: -105, under: -110 },
    moneyline: { home: -185, away: 166 },
    split: { moneyHome: 66, ticketsHome: 54 },
  },
  {
    ...
    total: { current: 47, over: -111, under: -108 },
    moneyline: { home: 134, away: -145 },
    split: { moneyHome: 11, ticketsHome: 33 },
  },
  {
    ...
    spread: { open: -3.5, current: -4, home: -115, away: -105 },
    total: { current: 50.5, over: -108, under: -108 },
    moneyline: { home: -200, away: 171 },
    split: { moneyHome: 46, ticketsHome: 43 },
  },
  {
    ...
    home: "Detroit Lions",
    spread: { open: -7.5, current: -7, home: -105, away: -115 },
    total: { current: 49.5, over: -111, under: -123 },
    moneyline: { home: -305, away: 280 },
    split: { moneyHome: 73, ticketsHome: 30 },
  },
  {
    ...
    away: "Buffalo Bills",
    home: "Houston Texans",
    spread: { open: 1.5, current: 1.5, home: -122, away: 102 },
    total: { current: 44.5, over: -108, under: -108 },
    moneyline: { home: -104, away: -110 },
    split: { moneyHome: 45, ticketsHome: 40 },
  },
  {
    ...
    spread: { open: 4.5, current: 3.5, home: -115, away: -105 },
    total: { current: 47.5, over: -108, under: -125 },
    moneyline: { home: 165, away: -175 },
    split: { moneyHome: 19, ticketsHome: 41 },
  },
  {
    ...
    spread: { open: -7.5, current: -8, home: -108, away: -112 },
    total: { current: 40.5, over: -110, under: -110 },
    moneyline: { home: -400, away: 340 },
    split: { moneyHome: 74, ticketsHome: 44 },
  },
  {
    ...
    spread: { open: -2.5, current: -3.5, home: -102, away: -118 },
    total: { current: 41.5, over: -110, under: -115 },
    moneyline: { home: -160, away: 155 },
    split: { moneyHome: 67, ticketsHome: 45 },
  },
  {
    ...
    spread: { open: -1.5, current: -1.5, home: -110, away: -110 },
    total: { current: 39.5, over: -108, under: -110 },
    moneyline: { home: -124, away: 125 },
    split: { moneyHome: 43, ticketsHome: 57 },
  },
  {
    ...
    spread: { open: -8.5, current: -10, home: -105, away: -115 },
    total: { current: 47.5, over: -102, under: -110 },
    moneyline: { home: -500, away: 475 },
    split: { moneyHome: 77, ticketsHome: 43 },
  },
  {
    ...
    spread: { open: -3, current: -3.5, home: -105, away: -115 },
    total: { current: 40.5, over: -105, under: -118 },
    moneyline: { home: -176, away: 157 },
    split: { moneyHome: 62, ticketsHome: 45 },
  },
  {
    ...
    spread: { open: 2.5, current: -1.5, home: -108, away: -112 },
    total: { current: 46.5, over: -107, under: -110 },
    moneyline: { home: -110, away: 102 },
    split: { moneyHome: 66, ticketsHome: 66 },
  },
  {
    ...
    spread: { open: -4.5, current: -5, home: -108, away: -112 },
    total: { current: 44.5, over: -105, under: -122 },
    moneyline: { home: -218, away: 198 },
    split: { moneyHome: 71, ticketsHome: 56 },
  },
  {
    ...
    spread: { open: 2.5, current: 3, home: -112, away: -108 },
    total: { current: 47.5, over: -108, under: -115 },
    moneyline: { home: 136, away: -148 },
    split: { moneyHome: 5, ticketsHome: 61 },
  },
  {
    ...
    spread: { open: -2.5, current: -2.5, home: 100, away: -120 },
    total: { current: 43.5, over: -105, under: -110 },
    moneyline: { home: -142, away: 130 },
    split: { moneyHome: 22, ticketsHome: 42 },
  },
];
